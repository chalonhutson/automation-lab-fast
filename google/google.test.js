...
test('I can search Google', async () => {
    ...
    // This time you'll just finish this string with something you want to search on Google, make sure you leanve <<--- typo :p that \n !
    await searchBar.sendKeys('Elder Scrolls 6\n')
    ...
    await searchBar.sendKeys('The Witcher 4\n')
